...
{
    EXPECT_NO_THROW(presenter.handleInputEvent(InputEvent{InputEvent::Type::keyboard, InputEvent::Action::press, KEY_PLAYPAUSE}));
}

TEST_F(RemotePresenterTests, registerPlayPauseKeyHandler_sendPlayPauseKeyEvent_handlerFunctionCalled)
{
    ...
    presenter.registerKeyEventHandler(
        RemotePresenter::Key::play_pause, 
        InputEvent::Action::press, 
        [&playPauseHandler]{ playPauseHandler.keyEventHandler(); });
    presenter.handleInputEvent(InputEvent{InputEvent::Type::keyboard, InputEvent::Action::press, KEY_PLAYPAUSE});
}

TEST_F(RemotePresenterTests, registerPlayPauseKeyHandler_sendBackspaceKeyEvent_noAction)
{
    KeyEventHandlerMock playPauseHandler;
    ...
    presenter.registerKeyEventHandler(
        ...
        InputEvent::Action::press, 
        [&playPauseHandler]{ playPauseHandler.keyEventHandler(); });
    presenter.handleInputEvent(InputEvent{InputEvent::Type::keyboard, InputEvent::Action::press, KEY_BACKSPACE});
}